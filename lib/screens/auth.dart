...
class _AuthorizationPageState extends State<AuthorizationPage> {
  ...
  Widget _logo(){
    return Padding(
        ...
        child: Container(
            child: Align(
              child: Text('MAXFIT', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 45, color: Colors.white)),
            )
        )
    );
  }
  ...
  void _registerButtonAction() async {
    ...
    Client? client = await _authService.registerInWithEmailAndPassword(
  ...
  void _loginButtonAction() async {
    ...
    Client? client = await _authService.signInWithEmailAndPassword(
        _email!.trim(), _password!.trim());
